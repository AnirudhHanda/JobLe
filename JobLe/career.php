  ...
  <div class="collapse navbar-collapse" id="navbarNav" style = "margin-top: -4.9rem;">
    <ul class="navbar-nav" style = "margin-left: 54rem;">
      <li class="nav-item active;">
        <a class="nav-link" href="index.php" style = "color:#DCE6FC; margin-left: 50px; padding-left: 10px;">Jobs <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link" href="login.php" style = "color: #DCE6FC; margin-left: 50px ; z-index: -1;" >Sign In/Sign Up</a> 
      </li>
    </ul>
  </div>
</nav>
